const Footer = () => (
  <div>
    <div className="mx-auto py-32 md:py-36 lg:py-190px w-full bg-ui-black px-container-sm md:px-container-md lg:px-container-lg">
      <div className="w-full lg:max-w-792px mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full">
          ...
          <button className="px-1.5 py-1 flex flex-row justify-start items-center rounded group hover:bg-ui-peach hover:bg-opacity-20 transition-colors duration-300 mt-7 md:mt-0">
        ...
        <div className="mt-12 font-Poppins font-medium text-sm-links-md md:text-md-links-md lg:text-lg-links-md text-ui-grey">
          <div>
            <a href="mailto:lira.digitalvoice@gmail.com" className="p-1 hover:text-ui-white hover:underline hover:bg-ui-black80 rounded transition-all duration-300">
              lira.digitalvoice@gmail.com
            </a>
          </div>
          <div className="mt-4 md:mt-5 lg:mt-7">
            <a href="tel:+37368356821" className="p-1 hover:text-ui-white hover:underline hover:bg-ui-black80 rounded transition-all duration-300">
              +373 (68) 356 821
            </a>
          </div>
        </div>
