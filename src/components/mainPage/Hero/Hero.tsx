  ...
  return(
    <div>
      ...
      <div className={classNames('w-full h-full')}>
        <canvas className={classNames('h-screen w-full')}>
        </canvas>
      </div>
      <div className={classNames('h-screen w-full flex flex-col justify-center items-center px-container-sm md:px-container-md lg:px-container-lg bg-ui-black90', styles.hero)}>
        ...
        <div className={classNames('hover:-mt-2 transition-all relative z-40', styles.hero_mouse)} ref={lottieRef} onClick={() => scrollDown()}/>
      </div>
    </div>
  )
}
