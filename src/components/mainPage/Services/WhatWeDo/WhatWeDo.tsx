  ...
  return (
    <div
      className={classNames(
        'h-200px rounded overflow-hidden group transform hover:scale-95 transition duration-300',
      )}
    >
      <div
        className={classNames(
          'w-full h-full transform group-hover:scale-110 transition duration-300 bg-ui-cardBg',
          styles.whatwedo_card,
        )}
      >
      ...
      <div
        className={classNames(
          '-mt-200px group-hover:-mt-238px w-full h-full flex flex-col justify-end items-start',
      ...
      <div className="text-ui-peach pl-6 font-Poppins text-md-button-md flex flex-row justify-start items-center">
        <div className="mr-2">{t('Learn more')}</div>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/ui/rightArrow3.svg" className="w-4 h-4" alt="Arrow" />
      </div>
    </div>
  )
}
      ...
      <div className="w-full flex flex-row justify-center items-center">
        <div className="group rounded overflow-hidden">
          <Link href="/project-request">
            <button
              className={classNames(
                'relative z-10 mx-auto h-14 mf:h-16 px-20 text-ui-white text-sm-button-md md:text-lg-button-md font-bold font-Poppins',
                styles.whatwedo_gradientBorder,
              )}
            >
              {t('Learn more')}
            </button>
          ...
          <div
            className={classNames(
              'w-full h-16 -mt-16 relative z-0 opacity-0 group-hover:opacity-100 transition duration-300',
              styles.whatwedo_gradientBg,
            )}
          ></div>
        </div>
      </div>
