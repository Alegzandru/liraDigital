...
const Card = ({
  ...
  return (
    ...
    //   )}
    // >
    <div className="mr-6 h-full transition-all duration-300 rounded-xl">
      ...
      > */}
      <div className="text-ui-white font-Poppins mt-4 text-sm-p md:text-md-p lg:text-lg-p ml-8">
        {name}
      </div>
    </div>
  )
